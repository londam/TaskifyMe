// this was for a direct link to Deepgram but we switched to callbacks now!
// so this is free for actual usual Post req to the mongoDB.
// And also to add all others here to move data out of the URL!
